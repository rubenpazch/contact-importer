...
u1 = User.create(email: 'rubenp@gmail.com', password: '123456')
...
#up1 = Upload.create(status: 1, total_items: 500, name: 'test1.csv', user_id: u1.id)
#up2 = Upload.create(status: 2, total_items: 300, name: 'test2.csv', user_id: u1.id)
#up3 = Upload.create(status: 3, total_items: 200, name: 'test3.csv', user_id: u1.id)
